...
class EventPageStage extends State<eventPage>
    implements CreateUserCallBack, GetUserCallBack, DeleteUserCallBack {
  ...
  String _nombre;
  CreateUserResponse _responseCreate = new CreateUserResponse(null);
  GetUserResponse _responseGet = new GetUserResponse(null);
  DeleteUserResponse _responseDelete = new DeleteUserResponse(null);
      ...
      return new Scaffold(
          appBar: AppBar(title: Text("Events"), actions: [
            Container(
              ...
              width: 60,
              child: Text(
                listNombres.nombresFavoritos.length.toString(),
            ...
            children: [
              for (int i = 0; i < listNombres.listaNombres.length; i++) ...{
                ListTile(
                  leading: FlutterLogo(),
                  title: Text(
                    listNombres.listaNombres[i]['name']['first'],
                    textAlign: TextAlign.center,
                  ),
                  trailing: Icon(
                    Icons.star,
                    color: listNombres.favorite[i],
                  ),
                  onTap: () => {
                    listNombres.changeColor(Colors.yellow[600], i),
                    listNombres.addNombresFavoritos(
                        listNombres.listaNombres[i]['name']['first'])
                  },
                )
              }
